...
#include <ndt_msgs/ConfigNDTMapping.h>
#include <ndt_msgs/ConfigNDTMappingOutput.h>
...
static double max_scan_range = 50.0;
...
static void param_callback(const ndt_msgs::ConfigNDTMapping::ConstPtr& input)
{
...
static void output_callback(const ndt_msgs::ConfigNDTMappingOutput::ConstPtr& input)
{
...
int main(int argc, char** argv)
{
  ...
  ROS_INFO("Subscriber was setupped");
  ros::spin();
